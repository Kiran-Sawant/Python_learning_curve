...
rightFrame.pack(side='right', anchor='n', expand=True)            # expand allows the Frame to strech acording to the widgets in it
...
mainWindow.mainloop()                                             # mainloop() keeps the window running.