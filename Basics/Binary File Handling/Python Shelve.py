...
# #________________Creating shelve using with ststement_____________#
# with shelve.open('ShelfTest') as fruit: # creating a shelve file with db name as ShelfTest assigned to variable fruit
#     fruit['Orange'] = "a sweet, orange, citrus fruit" #assigning objects with keys[] in shelve
#     fruit['apple'] = "Good for making cider"          #shelve keys must be a string
